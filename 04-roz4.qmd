...
Dane teledetekcyjne zazwyczaj reprezentują dane ciągle o szerokim zakresie, które niejednokrotnie mogą przyjmować zarówno wartości dodatnie, jak i ujemne, niekoniecznie ograniczając się do liczb całkowitych [@R-GLCMTextures].
...
Z uwagi na rosnący koszt i czas obliczeń wraz z zwiększaniem liczby poziomów szarości, zdecydowano się na kwantyzację wartości rastrów do 32 poziomów szarości.
