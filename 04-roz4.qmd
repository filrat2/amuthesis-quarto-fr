...
Kolejnym krokiem było połączenie przetworzonych danych źródłowych i ich produktów pochodnych w kilka wariantów zbiorów danych, stworzonych do na potrzeby detekcji farm fotowoltaicznych.
...
Przetwarzanie danych Sentinel-1 GRD zostało przeprowadzane przy użyciu oprogramowania Sentinel-1 Toolbox (S1TBX) [@s1tbx] i SNAP [@snap], udostępnianego przez Europejską Agencję Kosmiczną (ang. ang. *European Space Agency*, ESA).
