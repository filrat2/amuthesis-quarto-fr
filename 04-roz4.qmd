...
W pracy wykorzystano schemat przetwarzania danych Sentinel-1 GRD zaproponowany przez @filipponi_2019_s1_workflow, który obejmuje:

1.   aktualizację danych o położeniu satelity w momencie zobrazowania poprzez pobranie i zastosowanie pliku orbity;

2.  usuwanie szumów termicznych;
...
Przepróbkowanie (ang. *resampling*) zostało przeprowadzone przy wykorzystaniu języka R (@R-base) oraz funkcji *resample* z pakietu *terra* [@R-terra].
Wykorzystano interpolację dwuliniową (ang. *bilinear interpolation*) poprzez zastosowanie parametru *method=bilinear*.

### Łączenie danych {#sec-processing-data-merging}

Resampling S1 do siatki S2.
Złączenie kanałów i pozostałych danych w wielokanałowy raster.
