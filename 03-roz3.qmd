...
Sentinel-1 jest wyposażony w radar z z syntetyzowaną aperturą (ang. *Synthetic Aperture Radar*, SAR), pracujący w paśmie C na częstotliwości 5,405 GHz, co odpowiada długości fali 5,6 cm [@sentinel1_lulc; @sentinel1_instrument_payload].
...
#| echo: false
#| tbl-cap: "Tryby radaru Sentinel-1 (ESA, 2023)"
df = data.frame(
...
Dane wykorzystane do analizy pochodzą z produktów Ground Range Detected (GRD) zarejestrowanych w trybie Interferometric Wide Swath (IW) przez satelitę Sentinel-1A w dniu 8 maja 2023 roku.
