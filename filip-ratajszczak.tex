...
Podstawą polityki Unii Europejskiej w obszarze klimatu jest Europejski
Zielony Ład (ang. \emph{European Green Deal}), czyli zestaw inicjatyw
politycznych mających na celu przeprowadzenie transformacji ekologicznej
i osiągnięcie neutralności klimatycznej w UE do 2050 roku. Inicjatywy
takie jak Gotowi na 55 (ang. \emph{Fit For 55}) oraz rozporządzenie o
europejskim prawie klimatycznym mają zapewnić redukcję emisji gazów
cieplarnianych netto o co najmniej 55\% do 2030 roku. Zgodnie z
ustaleniami Rady UE, Parlamentu Europejskiego oraz Komisji Europejskiej,
udział energii odnawialnej w ogólnym zużyciu energii w Unii Europejskiej
ma wynosić 42,5\% do 2030 roku. Plan REPowerEU, przedstawiony przez
Komisję Europejską w maju 2022 roku, skupia się natomiast na
inwestycjach w odnawialne źródła energii, uznając je za leżące w
nadrzędnym interesie publicznym. Celem tego planu jest zmniejszenie
zależności UE od importu paliw kopalnych z Rosji poprzez zainstalowanie
niemal 600 GW mocy nowych paneli fotowoltaicznych w całej Unii
Europejskiej do 2030 roku. Ambitne cele klimatyczne Unii Europejskiej, w
połączeniu z równoczesnym obniżeniem kosztów instalacji fotowoltaicznych
sprawiają, że energia elektryczna pochodząca z tego źródła
prawdopodobnie zacznie odgrywać kluczową rolę w procesie transformacji
energetycznej Unii Europejskiej.

\begin{itemize}
\tightlist
\item
  dlaczego należy prowadzić statystykę rozwoju OZE? dlaczego
  monitorowanie tego zjawiska jest tak istotne?
\item
