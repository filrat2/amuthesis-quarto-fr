...
geografii, mówiącym, że „Wszystko jest powiązane ze wszystkim innym, ale
rzeczy bliskie są bardziej powiązane niż rzeczy odległe''
\autocite{tobler_1970_first_law_of_geography}, będącym jednocześnie
podstawowym założeniem analizy geostatystycznej. Konsekwencją
autokorelacji przestrzennej dla oceny jakości jest nadmierne dopasowanie
klasyfikatorów do obserwacji uczących, które może pozostać niewykryte,
jeśli obserwacje testowe (lub walidacyjne) nie są niezależne od zbioru
uczącego \autocite{brenning_2012_scv}. Przestrzenna walidacja krzyżowa
(ang. \emph{spatial cross-validation}) jest modyfikacją standardowej
kroswalidacji, która zapobiega błędom w ocenie jakości modelu
wynikającym z bliskości danych testowych i treningowych. Aby ograniczyć
nadmierny optymizm w ocenie jakości, podzbiory danych szkoleniowych
muszą zawierać tylko obserwacje, które znajdują się w określonej
odległości przestrzennej od siebie \autocite{pohjankukka_2017_scv}.
