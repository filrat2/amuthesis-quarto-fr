...
obrazów satelitarnych w trzynastu zakresach spektralnych, rozdzielczość
przestrzenna w zależności od rejestrowanego kanału to 10, 20 lub 60 m.
Rozdzielczość czasowa satelitów Sentinel-2 wynosi pięć dni nad równikiem
oraz wzrasta wraz ze wzrostem szerokości geograficznej do dwóch dni na
średnich szerokościach geograficznych \autocite{hejmanowska_2020_dane}.
