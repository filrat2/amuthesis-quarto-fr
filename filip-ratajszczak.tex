...
Sentinel-1 jest wyposażony w radar z z syntetyzowaną aperturą (ang.
...
\begin{table}
\caption{\label{tbl-tabela-sentinel1}Tryby radaru Sentinel-1 (ESA, 2023) }\tabularnewline
...
satelitę Sentinel-1A w dniu 8 maja 2023 roku. Zestaw danych został
...
\begin{table}
\caption{\label{tbl-tabela-sentinel2}Kanały spektralne satelitów Sentinel-2 }\tabularnewline
...
\textbf{B02} & \textbf{Blue} & \textbf{490} & \textbf{458–523} & \textbf{10}\\
\textbf{B03} & \textbf{Green} & \textbf{560} & \textbf{543–578} & \textbf{10}\\
\textbf{B04} & \textbf{Red} & \textbf{665} & \textbf{650–680} & \textbf{10}\\
\textbf{B05} & \textbf{Vegetation RedEdge} & \textbf{705} & \textbf{698–713} & \textbf{20}\\
\addlinespace
...
\textbf{B08} & \textbf{NIR} & \textbf{842} & \textbf{785–900} & \textbf{10}\\
...
korekcji wpływu aerozoli, kanał 9 (940 nm) do korekcji wpływu pary
wodnej, a kanał 10 (1375 nm) do wykrywania chmur typu cirrus
...
przedziale czasowym, co umożliwia generowanie wysokorozdzielczych
mozaik, które są dokładne radiometrycznie i przestrzennie, a także
charakteryzują się zminimalizowanym wpływem czynników atmosferycznych
...
teledetekcyjnych, a zaimplementowane narzędzie przetwarzania grafów
